...
ARG BUILD_DATE="Fri Aug  9 12:56:19 PM EDT 2024"
...
ARG PACK_LIST="bash-completion git curl wget sudo unzip tini xz-utils iproute2 locales procps net-tools bsd-mailx postfix \
  "
...
LABEL \
  ...
  org.opencontainers.image.url="https://hub.docker.com/r/casjaysdev/ubuntu" \
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdev/ubuntu" \
  org.opencontainers.image.vcs-type="Git" \
  org.opencontainers.image.vcs-ref="${BUILD_VERSION}" \
  org.opencontainers.image.vcs-url="https://github.com/casjaysdev/ubuntu" \
  org.opencontainers.image.documentation="https://github.com/casjaysdev/ubuntu" \
