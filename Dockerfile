...
ARG BUILD_DATE="Fri Sep  1 02:49:45 AM EDT 2023"
...
ARG PACK_LIST="bash bash-completion git curl wget sudo unzip tini xz-utils iproute2 locales procps net-tools bsd-mailx postfix"
...
LABEL \
  ...
  org.opencontainers.image.url="https://hub.docker.com/r/casjaysdev/docker-ubuntu" \
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdev/docker-ubuntu" \
  org.opencontainers.image.vcs-type="Git" \
  org.opencontainers.image.vcs-ref="${BUILD_VERSION}" \
  org.opencontainers.image.vcs-url="https://github.com/casjaysdev/docker-ubuntu" \
  org.opencontainers.image.documentation="https://github.com/casjaysdev/docker-ubuntu" \
